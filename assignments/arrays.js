...
var result = inventory.find(number => number.id === 33);
...
let lastCar = 0;
var last_id = inventory.length-1;
lastCar = inventory[last_id];
...
let year_set = new Set(carYears);
  
carYears = [...year_set].sort();
  
console.log("Vehicle Year range : " + carYears)
...
console.log("Total Oldies: " + b42k + " , List of Years: " + oldCars);
